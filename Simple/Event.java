...
class Event implements Comparable<Event> {
    ...
    public void update(PriorityQueue<Event> scheduler, Monitor monitor, double current_time) {
        ...
        switch (this.getStatus()) {
            case BIRTH:
                ...
                if (monitor.requests.size() == 1) {
                    ...
                    scheduler.add(new Event(time + Simulator.getNextDeath(), EventState.DEATH));
